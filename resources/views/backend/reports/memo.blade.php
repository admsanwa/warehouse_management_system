                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-3">
                                            <button type="button" id="filter" class="btn btn-primary" style="margin-top: 20px"><i
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="memoTable" class="table table-bordered table-striped"></table>
                                    <p></p>
                                </div>
                            </div>
    ...
    $(function () {
        let table = $("#memoTable").DataTable({
                        ...
                        $(win.document.body)
                            ...
                            .prepend(`
                                <div style="text-align:center; margin-bottom:20px;">
                                    <h4 style="margin:0;">Report Memo</h4>
            ...
            columns: [
                ...
                { data: 'no', title: 'No Memo' },
                { data: 'date', title: 'Tanggal Memo' },
                { data: 'unit', title: 'Komponen' },
                { data: 'uom', title: 'Satuan' },
                { data: 'qty', title: 'Qty' }
                // { data: 'remark', title: 'Keterangan' },
                // { data: 'receipt_date', title: 'Tanggal Terima'}
                // { data: 'receipt_qty', title: 'Qty Terima'},
                // { data: 'remain_qty', title: 'Qty Sisa'},
                // { data: 'reason_qty', title: 'Alasan Qty Sisa'}
            ]
        });
        ...
        $("#reset").click(function() {
            $('#start_date, #end_date, #no_memo').val('');
