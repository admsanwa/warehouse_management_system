                    ...
                    <div class="card card-info">
                        ...
                        <form class="form-horizontal" method="post" enctype="multipart/form-data">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-lable">Manager Id<span style="color: red">*</span></label>
                                    <div class="col-sm-10">
                                        {{ $getRecord->manager_id}}
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-lable">Department Id<span style="color: red">*</span></label>
                                    <div class="col-sm-10">
                                        {{ $getRecord->department_id}}
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-lable">Is Role<span style="color: red">*</span></label>
                                    <div class="col-sm-10">
                                        {{ $getRecord->role}}
                                    </div>
                                </div>
