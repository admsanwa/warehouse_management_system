                            ...
                            <form action="{{ url('admin/employees/edit/' . $getRecord->id) }}" class="form-horizontal"
                                ...
                                <div class="card-body">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="username" value="{{ $getRecord->username }}"
                                                class="form-control" required placeholder="Enter First Username">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="department" value="{{ $getRecord->department }}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="level" value="{{ $getRecord->level }}"
                                                class="form-control required" required placeholder="Enter Level">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-lable">Warehouse</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" placeholder="" name="warehouse"
                                                value="{{ $getRecord->warehouse_access }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            @if ($getRecord->sign)
                                                ...
                                                <img src="{{ asset('assets/images/sign/' . $getRecord->sign) }}"
                                                    alt="User Signature" style="max-height: 100px;">
                                            @endif
                                        </div>
                                    </div>
                                </div>
