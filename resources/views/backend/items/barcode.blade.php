                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" name="code" value="{{ Request()->code }}"
                                                class="form-control" placeholder="Enter Item Code">
                                        </div>
                                        <div class="form-group col-md-3">
                                        ...
                                        @forelse ($getRecord as $key => $value)
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form action="{{ url('admin/items/add') }}" method="POST"
                                            ...
                                            <tbody>
                                                @foreach ($addedBarcodes as $barcode)
                                                    <tr>
                                                        ...
                                                        <td>{{ $barcode->qty }}</td>
                                                        <td><a href="{{ url('admin/items/delete/' . $barcode->id) }}"
                                                        ...
                                                        <div class="d-flex flex-wrap">
                                                            ...
                                                            <a href="{{ url('admin/items/print') }}"
                                                                class="btn btn-success mr-2 mb-2"><i
                                                                    class="fa fa-arrow-right"></i> Print</a>
