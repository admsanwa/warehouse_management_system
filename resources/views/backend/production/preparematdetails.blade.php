                ...
                <div class="row">
                    <section class="col col-md-12">
                        <div class="card shadow-sm">
                            ...
                            <form action="{{ url('preparematdetails/' . $getRecord['DocEntry']) }}" method="POST"
                                ...
                                <div class="card-body">
                                    @php
                                        $seriesValue =
                                            !empty($series) && isset($series['ObjectCode'], $series['SeriesName'])
                                                ? $series['SeriesName']
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="number" name="DocNum" class="form-control"
                                                value="{{ $getRecord['DocNum'] }}" readonly>
                                        </div>

                                        <div class="col-md-4">
                                            <label class="form-label fw-semibold">Product No</label>
                                            <input type="text" name="ItemCode" class="form-control"
                                                value="{{ $getRecord['ItemCode'] }}" readonly>
                                        </div>

                                        <div class="col-md-4">
                                            <label class="form-label fw-semibold">Product Description</label>
                                            <input type="text" class="form-control" value="{{ $getRecord['ItemName'] }}"
                                                readonly>
                                        </div>

                                        <div class="col-md-4">
                                            <label class="form-label fw-semibold">Due Date</label>
                                            <input type="text" class="form-control" value="{{ $getRecord['DueDate'] }}"
                                                readonly>
                                        </div>

                                        <div class="col-md-4">
                                            <label class="form-label fw-semibold">Distr Rule</label>
                                            <input type="text" class="form-control" value="{{ $getRecord['OcrCode'] }}"
                                                readonly>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control text-end"
                                                value="{{ formatDecimalsSAP($getRecord['CmpltQty'] + $getRecord['RjctQty']) }}"
                                                readonly>
                                        </div>

                                        <div class="col-md-4">
                                            <label class="form-label fw-semibold">Status</label>
                                            <input type="text" class="form-control" value="{{ $getRecord['Status'] }}"
                                                readonly>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="number" class="form-control"
                                                value="{{ $getRecord['OriginNum'] }}" readonly>
                                        </div>
                                    </div>
                                </div>
