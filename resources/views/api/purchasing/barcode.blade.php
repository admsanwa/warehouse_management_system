                ...
                <div class="row">
                    <section class="col-md-12">
                        ...
                        <div class="card">
                            ...
                            @else
                                <form action="{{ url('/print/pdfmaklon') }}" method="POST" enctype="multipart/form-data"
                                                ...
                                                <div class="unit-block mb-3 p-3 border rounded bg-light">
                                                    <div class="form-row align-items-end">
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <select name="codes[]" class="select2 form-control"
                                                                style="width: 100%"></select>
                                                            <input type="hidden" name="names[]" class="form-control"
                                                                readonly>
                                                        </div>
                                                        ...
                                                        <div class="form-group col-md-1 text-center">
                                                            <button type="button"
                                                                class="btn btn-success btn-add-unit mb-1">
